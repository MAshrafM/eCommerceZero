    ...
    <div class="row">
      <div class="col-md-2">
        <?php if(empty($info['Avatar'])) { ?>     
          <img src="./layout/images/holder.png" alt="holder" class="img-responsive img-thumbnail img-circle" />
        <?php } else { ?>
          <img src="./admin/uploads/avatars/<?php echo $info['Avatar']; ?>" alt="pic" class="img-responsive img-thumbnail img-circle" />
        <?php } ?>
      </div>
      <div class="col-md-10">
